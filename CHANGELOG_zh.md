...
- 修复 issue #150：在多帧投票中保留一致多数裁定的主要视频水印轨道，消除 720×1280 竖屏 Veo 视频在第 0 帧与第 50 帧处因投票权重归一化引发的 24px 错误候选跳变，保持 48px 单轨稳定追踪。
- 对真实混合或交替水印场景（issue #136a、#136b）继续保留多轨道检测与跟踪能力。
- 保留现有内容保护与尽力输出行为；本次更新不修改图片水印算法或 issue #165 候选保留逻辑，亦不作广泛视频 GA 承诺。
